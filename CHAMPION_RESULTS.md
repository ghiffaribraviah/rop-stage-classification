...
model saw. Script: [`experiments/masked_cnn_cv_champion.py`](./experiments/masked_cnn_cv_champion.py).
...
- **Vessel channel = the locked vessel-segmentation champion** `g40_m60_fine`
  (Dice 0.4739, see [`experiments/VESSEL_FINDINGS.md`](./experiments/VESSEL_FINDINGS.md)):
