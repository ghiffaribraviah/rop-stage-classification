...
\textbf{0,4739} pada dataset HVDROPDB-BV. Kanal \textit{ridge} dievaluasi dengan protokol yang
sama terhadap HVDROPDB-RIDGE untuk memeriksa kesesuaian peta \textit{ridge} dengan anotasi
garis batas dan tonjolan retina. Evaluasi ini berperan sebagai validasi spasial pendukung,
sementara eksperimen utama penelitian tetap berfokus pada dampak representasi \textit{softmap}
terhadap performa klasifikasi \textit{stage} ROP.
