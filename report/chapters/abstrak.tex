...
pembuluh darah mencapai nilai Dice \textbf{0,4739} pada dataset HVDROPDB-BV. Percobaan ablasi yang terkontrol menunjukkan bahwa
...
the vessel segmentation workflow achieves a Dice score of \textbf{0.4739} on the HVDROPDB-BV
dataset. A controlled ablation experiment
