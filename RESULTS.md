...
The **fused classical pipeline** (`experiments/rop_classical.py`, 48 features =
...
Script: `experiments/masked_cnn_cv.py`.
...
python experiments/rop_classical.py    # ~28 min CPU, writes fused_run.log
```

Source log: `experiments/output/fused_run.log`
Script: `experiments/rop_classical.py`
