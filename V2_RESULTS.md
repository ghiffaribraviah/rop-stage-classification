...
Script: [`experiments/masked_cnn_cv_v2.py`](./experiments/masked_cnn_cv_v2.py).
...
python experiments/masked_cnn_cv_v2.py --mode full --protocol stratified --epochs 160
# grouped (leakage-corrected, honest)
python experiments/masked_cnn_cv_v2.py --mode full --protocol group --epochs 160
```
